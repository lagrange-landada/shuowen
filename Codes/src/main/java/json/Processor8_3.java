...
/***
 * Created by zhengyu.shang on 2024/11/19.   --- 新版《说文》SQL导出脚本：主要添加了三个字段：
 * voice_read、voice_base、part_base
 */
            ...
            if (paragraphs != null && paragraphs.size() > 0) {
                for (XWPFParagraph paragraph : paragraphs) {
                    ...
                    if (paragraphText.length() == 0) {
                        ...
                        List<String> voiceReads = new ArrayList<>();
                        ...
                        for (XWPFRun run : paragraph.getRuns()) {
                            ...
                            for (String ss : run.text().codePoints()
                                ...
                                // 粉色 读若音
                                if (Objects.equals(color, "CC00CC")) {
                                    voiceReads.add(ss);
                                    parts.add(ss);
                                    isXsWord = 1;
                                }
                        ...
                        voiceRead = String.join(";", voiceReads);
